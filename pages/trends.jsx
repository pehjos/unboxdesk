...
useEffect(() => {
  const fetchVideo = async () => {
    const response = await fetch("api/alltrend", {
      method: "GET",
      headers: { "Content-Type": "application/json" },
    });
    const responseData = await response.json();
...
NewsPosts
 ...
 <Head>
        <title>Best Trending Products Review - Best Products & Services Buying Guides & Ratings</title>
        ...
        <link rel="canonical" href="https://www.unboxdesk.com/trends" />
      </Head>
  <div>
