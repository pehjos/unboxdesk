...
useEffect(() => {
  const fetchVideo = async () => {
    const response = await fetch("api/cammera", {
      method: "GET",
      headers: { "Content-Type": "application/json" },
    });
    const responseData = await response.json();
...
NewsPosts
  ...
  return (
    <div className='home'>
   <Head>
  <title>best cammeras and lights to buy in 2023 </title>
  <link
          rel="canonical"
          href="https://unboxdesk.com/cammera"
          key="canonical"
        />
  <meta name="description" content="best cammeras and lights to buy in 2023 that will save your money" />
  <meta property="og:title" content="best cammeras and lights to buy in 2023 that you did not know" />
  ...
  <meta property="og:url" content="https:/unboxdesk.com/cammera" />
